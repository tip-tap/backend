# Generated by Django 4.0 on 2022-08-05 17:30
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='BasicInfo',
            fields=[
                ('basicInfo_id', models.AutoField(primary_key=True, serialize=False)),
                ('basicInfo_move_in_date', models.DateTimeField(blank=True, null=True)),
                ('basicInfo_type', models.CharField(blank=True, choices=[('J', 'Jeonse'), ('BJ', 'Ban Jeonse'), ('M', 'Monthly Rent'), ('', 'not selected')], max_length=2, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('brokerAgency_number2', models.CharField(blank=True, max_length=20, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('checklist_is_private', models.BooleanField(blank=True, default=True, null=True)),
                ('brokerAgency_name', models.TextField(blank=True, null=True)),
                ('brokerAgency_contact', models.TextField(blank=True, null=True)),
                ('location_x', models.DecimalField(blank=True, decimal_places=7, max_digits=10, null=True)),
                ('location_y', models.DecimalField(blank=True, decimal_places=7, max_digits=10, null=True)),
                ('basicInfo', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='app.basicinfo')),
            ],
        ),
        migrations.CreateModel(
            name='DetailInfo',
            fields=[
                ('detailInfo_id', models.AutoField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location_y', models.DecimalField(blank=True, decimal_places=7, max_digits=10, null=True)),
                ('basicInfo', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='app.basicinfo')),
                ('brokerAgency', models.ManyToManyField(blank=True, to='app.BrokerAgency')),
                ('options', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.option')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('basicInfo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.basicinfo')),
            ],
        ),
        migrations.CreateModel(
            name='ConfirmedRoom',
        ...
        migrations.AddField(
            ...
            name='detailInfo',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='app.detailinfo'),
        ),
        migrations.AddField(
            model_name='checklist',
            name='option',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('brokerAgency', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.brokeragency')),
                ('user', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='auth.user')),
            ],
        ),
    ]
